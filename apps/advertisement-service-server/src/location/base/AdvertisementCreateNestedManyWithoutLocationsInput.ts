...
@InputType()
class AdvertisementCreateNestedManyWithoutLocationsInput {
...
export { AdvertisementCreateNestedManyWithoutLocationsInput as AdvertisementCreateNestedManyWithoutLocationsInput };
