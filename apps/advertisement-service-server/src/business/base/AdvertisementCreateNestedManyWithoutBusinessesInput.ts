...
@InputType()
class AdvertisementCreateNestedManyWithoutBusinessesInput {
...
export { AdvertisementCreateNestedManyWithoutBusinessesInput as AdvertisementCreateNestedManyWithoutBusinessesInput };
