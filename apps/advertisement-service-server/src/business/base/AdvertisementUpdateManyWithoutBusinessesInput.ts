...
@InputType()
class AdvertisementUpdateManyWithoutBusinessesInput {
...
export { AdvertisementUpdateManyWithoutBusinessesInput as AdvertisementUpdateManyWithoutBusinessesInput };
